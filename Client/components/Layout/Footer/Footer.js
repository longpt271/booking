...
const Footer = () => {
  return (
    <footer>
      ...
      <div
        className="container-fluid footer-main text-light footer wow fadeIn"
        data-wow-delay="0.1s"
      >
            ...
            <div className="col-lg-4 col-md-7 order-3 order-md-1 footer-item-wrap">
              ...
              <div className="d-flex pt-2">
                ...
                <Link
                  ...
                  to="/"
                >
                  <FontAwesomeIcon icon={faYoutube} className="footer-brands" />
                </Link>
              </div>
            </div>

            <div className="col-lg-4 col-md-5 order-2 order-md-2 footer-item-wrap quick-link-d-none">
